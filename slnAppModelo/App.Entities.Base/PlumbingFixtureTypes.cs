namespace App.Entities.Base
{
    ...
    public partial class PlumbingFixtureTypes
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public PlumbingFixtureTypes()
        {
        ...
        public int? Conexióndeventilación { get; set; }

        public int? Conexiónderesiduos { get; set; }

        public int? ConexiónAF { get; set; }

        public int? ConexiónAC { get; set; }
