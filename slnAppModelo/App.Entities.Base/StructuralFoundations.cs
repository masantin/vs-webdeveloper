namespace App.Entities.Base
{
    ...
    public partial class StructuralFoundations
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public StructuralFoundations()
        {
            RebarOnFoundation = new HashSet<RebarOnFoundation>();
        }
        ...
        public double? Elevaciónenparteinferior { get; set; }
        ...
        public int? Solado { get; set; }

        [Column("Mejoramiento de Terreno")]
        public double? Mejoramiento_de_Terreno { get; set; }
        ...
        public virtual ICollection<RebarOnFoundation> RebarOnFoundation { get; set; }

        public virtual StructuralFoundationTypes StructuralFoundationTypes { get; set; }
    }
}
