namespace App.Entities.Base
{
    ...
    public partial class StructuralRebarShapes
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public StructuralRebarShapes()
        {
        ...
        public int? Orientacióndeganchoalfinal { get; set; }

        public int? Orientacióndeganchoalinicio { get; set; }

        public int? Girosdeacabadodebase { get; set; }

        public int? Girosdeacabadodepartesuperior { get; set; }

        public double? Altura { get; set; }

        public double? Inclinacióntransversal { get; set; }
