namespace App.Entities.Base
{
    ...
    public partial class DemandFactorTypes
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public DemandFactorTypes()
        {
        ...
        public int? Clasificacióndecarga { get; set; }

        public double? Cargaconectada { get; set; }

        public double? Cargadedemandaestimada { get; set; }
        ...
        public virtual LoadClassificationTypeEnums LoadClassificationTypeEnums { get; set; }
