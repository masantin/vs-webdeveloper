namespace App.Entities.Base
{
    ...
    public partial class StructuralColumns
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public StructuralColumns()
        {
            RebarOnColumn = new HashSet<RebarOnColumn>();
        }
        ...
        [Column("LoadBearing(Pset_ColumnCommon)")]
        public int? LoadBearing_Pset_ColumnCommon_ { get; set; }

        [Column("Reference(Pset_ColumnCommon)")]
        [StringLength(255)]
        public string Reference_Pset_ColumnCommon_ { get; set; }
        ...
        public virtual ICollection<RebarOnColumn> RebarOnColumn { get; set; }

        public virtual StructuralColumnTypes StructuralColumnTypes { get; set; }
    }
}
