namespace App.Entities.Base
{
    ...
    public partial class MassExteriorWall
    {
        ...
        public double? Alturadeantepechodedestino { get; set; }

        public double? Profundidaddesombreado { get; set; }

        public int? Lacristaleraestásombreada { get; set; }

        public double? Porcentajedecristaleradedestino { get; set; }

        public int? Subterráneo { get; set; }

        public double? Áreademurosexterioresdemasa { get; set; }
