namespace App.Entities.Base
{
    ...
    public partial class DistributionSystemTypes
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public DistributionSystemTypes()
        {
        ...
        public int? Voltajeentrefases { get; set; }

        public int? Voltajedelíneaatierra { get; set; }

        public int? Fase { get; set; }

        public int? Configuración { get; set; }
        ...
        public virtual ElectricalPhaseConfigurationEnums ElectricalPhaseConfigurationEnums { get; set; }

        public virtual ElectricalPhaseEnums ElectricalPhaseEnums { get; set; }
