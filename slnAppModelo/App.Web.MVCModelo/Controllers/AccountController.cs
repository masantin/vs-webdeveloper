...
using App.Web.MVCModelo.Models;
using System;
...
namespace App.Web.MVCModelo.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(UserViewModel user)
        {
            ...
            var validUser = _unit.UsersRepository.ValidateUser(user.Email, user.Password);
            if (validUser == null)
            {
        ...
        public ActionResult Register(RegisterUserViewModel userView)
        {
            ...
            var validUser = _unit.UsersRepository.CreateUser(user);
            if (validUser == null)
            {
